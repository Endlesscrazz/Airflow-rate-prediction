...
def main():
    ...
    # Directory where the final .npy crops are stored
    DATASET_DIR = cfg.DATASET_DIR
    
    # Path to the final metadata file for the chosen split
    if args.split == 'train':
    ...
    for index, row in random_samples.iterrows():
        try:
            ...
            numeric_hole_id = hole_id_full.split('_')[0] # This will be "2"
            
            print(f"\nProcessing sample: {sample_id} (Video: {video_id}, Hole: {hole_id_full})...")
            ...
            # Now, search using the numeric ID
            ...
            # Plot 1: Original frame with crop box
            ...
            ax1.add_patch(rect)
            ax1.scatter([center_x], [center_y], s=50, c='cyan', marker='+') # Mark the exact center
            ax1.axis('off')
            
            # Plot 2: The saved cropped frame
