...
# Import your custom logging setup function
from src_feature_based.utils import setup_logging

def main(args):
    # Set up logging at the very beginning. All subsequent `print` calls will be captured.
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=42,
        help='The random state seed for the split to ensure reproducibility.'
    )
