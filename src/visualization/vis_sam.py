...
def main():
    ...
    parser.add_argument("--activity_method", type=str, default="theil_sen", choices=["theil_sen","kendall_tau"])
    parser.add_argument("--spatial_filter", type=str, default="none", choices=["none","bilateral"])
