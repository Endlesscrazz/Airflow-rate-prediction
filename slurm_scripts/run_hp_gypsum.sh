...
#SBATCH --job-name=hp-gypsum
#SBATCH --output=hyperparam-logs/gypsum_tuning-%j.out
...
export Target_Experiment="gypsum_all_dataset_v2"

echo "=================================================="
echo "STARTING JOB: Gypsum Hyperparam Search"
...
# --- 3. RUN OPTUNA ---
# The Python script automatically handles storage creation and resuming based on the folder path
